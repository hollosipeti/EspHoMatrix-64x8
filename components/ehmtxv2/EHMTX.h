...
namespace esphome::ehmtx
{
  ...
  const uint8_t TEXTSTARTOFFSET = (64 - 8);
  ...
  protected:
    ...
    uint8_t top_indicator_mask = 0; // Ebben tároljuk a 6 indikátor állapotát (bitmaszk)
    uint8_t screen_pointer;
    bool show_day_of_week;
    bool show_top_indicators;
  ...
  public:
    ...
    PROGMEM Color top_indicator_color_active; 
    PROGMEM Color top_indicator_color_inactive;
    ...
    void set_top_indicator(int32_t position, bool state);
    void set_top_indicator_def_colors(int32_t r, int32_t g, int32_t b, int32_t bg_r, int32_t bg_g, int32_t bg_b);
    void draw_top_indicators();    
    float get_tick();
    ...
    void set_show_top_indicators(bool b=true);
    ...
    std::vector<std::tuple<Color, std::string, uint16_t>> text_for_draw;
  #endif
    ...
    void flash_alert_screen(std::string icon, std::string text, int32_t screen_time = D_SCREEN_TIME, bool default_font = true, int32_t r = CA_RED, int32_t g = CA_GREEN, int32_t b = CA_BLUE);
    ...
    void icon_date_time_screen(std::string icon, int32_t lifetime = D_LIFETIME, int32_t screen_time = D_SCREEN_TIME, bool default_font = true, int32_t r = C_RED, int32_t g = C_GREEN, int32_t b = C_BLUE);
    ...
    void draw_rainbow_text(const std::string &text, esphome::display::BaseFont *font, int32_t xpos, int32_t ypos);
    
  #endif
    void draw_text(const std::string &text, esphome::display::BaseFont *font, Color color, int32_t xpos, int32_t ypos);
